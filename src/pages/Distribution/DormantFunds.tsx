          ...
          <Text style={{ fontSize: "12px" }}>
            <ul style={{ margin: "12px 0" }}>
              <li>
                ...
                <strong>{new BigNumber(availableSupply).toFormat()} FFD</strong>
              </li>
              <li>
                {t("pages.distribution.knownAccountBalances")}:{" "}
                <strong>{new BigNumber(totalFunds).toFormat()} FFD</strong>
              </li>
              <li>
                {t("pages.distribution.unknownDormantFunds")}:{" "}
                <strong>
                  {new BigNumber(unknownDormantFunds).toFormat()} FFD
                </strong>
              </li>
            </ul>
          </Text>
